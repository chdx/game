...
public class RedisConfig extends CachingConfigurerSupport {
	...
	public static final int databaseNo = 10;
	...
	MessageListener messageListener(CountDownLatch latch) {
		MessageListener messageListener = new MessageListenerRedis(latch);
	...
	JedisConnectionFactory jedisConnectionFactory(){
		...
		connectionFactory.setDatabase(databaseNo);
	...
	MessageListener messageNotifyRedis(CountDownLatch latch) {
		MessageListener messageListAdap = new MessageNotifyRedis(latch);
